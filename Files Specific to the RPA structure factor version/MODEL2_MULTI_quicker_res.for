...
!FOR N CONNECTED CYCLINDERS UNDER SHEAR- WRITTEN BY GREG SMITH JANUARY 2021; UPDATED DECEMBER 2022
      ...
      !               3. CALCULATES S(Q) BASED ON RPA FORM FACTOR. 
...
!   B(10) IS THE INITIAL NUMBER OF ITERATIONS USED IN THE VEGAS INTEGRATION CALCULATIONS
...
!      QL=REAL(QP,16)*REAL(B(13),16)                   !B(13) IS A APPARENT LENGTH SCALE FOR THE THIN ROD AND ISN'T THE SAME AS THE LENGTH OF THE CYLINDERS
!      TERM0=REAL(0.,16)
!          DO 121 I=0,150
...
!**************************************************************      
  ...
  ! CALCULATE THE MEAN OF THE CYLINDER RADIUS  FOR THE NORMALIZATION       
      ...
      YOUT=YOUT/INT2                          !DIVIDE BY INTEGRAL OF R^2*EXP(-(R-R0)^2/2*SIGMA^2) TO GET NORMALIZED P(Q)
          ...
          DO 740 I=1,NPRI
          YOUT(I)=YOUT(I)/(1.0D0+BETA*YOUT(I))     !PRISM STYLE FORM FACTOR WITH Q-DEPENDENT CQ1
740       CONTINUE                
